...
Centralized utilities for compliance, AML, and sanctions.
Avoids duplication of logic between agents.
"""
...
class ComplianceUtils:
    ...
    async def perform_aml_analysis(self, wallet_address: str, agent_id: str, agent_style: str = "neutral") -> Dict:
        """
        Centralized AML analysis that can be used by different agents.

        Args:
        wallet_address: Wallet address for analysis
        agent_id: ID of the agent making the call
        agent_style: Agent style ("analytical", "direct", "methodical", "neutral")
        """
        try:
            # Base prompt
            base_aml_analysis = {
            ...
            # Personalization by agent style
            style_prompts = {
    ...
    async def perform_regulatory_assessment(self, wallet_address: str, agent_id: str, agent_style: str = "neutral") -> Dict:
        """
        Centralized regulatory assessment.
        """
        try:
            style_prompts = {
