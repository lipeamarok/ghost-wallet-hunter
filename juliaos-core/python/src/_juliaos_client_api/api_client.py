...
import _juliaos_client_api.models
from _juliaos_client_api import rest
from _juliaos_client_api.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(_juliaos_client_api.models, klass)
